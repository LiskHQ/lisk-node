...
- To build `op-reth` from source, refer to the [`op-reth` source tree](https://github.com/ethereum-optimism/optimism/tree/op-reth%2Fv2.4.2/rust/op-reth) in the `ethereum-optimism/optimism` repository (pinned to the version above).
